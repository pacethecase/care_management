  ...
  try {
    ...
    const result = await pool.query(`
      SELECT 
       ...
       TO_CHAR(p.guardianship_court_datetime AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS"Z"') AS guardianship_court_datetime,
        TO_CHAR(p.ltc_court_datetime AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS"Z"') AS ltc_court_datetime,
        p.created_at,
        p.added_by_user_id,
