...
const tasks = [
    ...
    {name:"Appropriate Office Contacted ASAP", description:"Contact Appropriate Office", is_repeating:false, recurrence_interval:null, max_repeats:null ,condition_required:"If Emergency Petition Required",category:"Initial Contract",dependency_name:null,algorithm:"Guardianship" },

    {name:"Court Petition Initiated",description:"Initiate the court Petition",is_repeating:false,recurrence_interval:null,max_repeats:null,condition_required:null,category:"Court",dependency_name:null,algorithm:"Guardianship"},
    {name:"Court Petition Filed",description:"File the Court Petition",is_repeating:false,recurrence_interval:null,max_repeats:null,condition_required:null,category:"Court",dependency_name:["Court Petition Initiated"],due_in_days_after_dependency: 2,algorithm:"Guardianship"},


    {name:"Confirm Guardianship Appointed", description:"Guardianship Appointed should be confirmed",is_repeating:false,recurrence_interval:null, max_repeats:null,condition_required:"only if emergency",category:"GuardianShip",dependency_name:["Court Petition Filed"],due_in_days_after_dependency: 3,algorithm:"Guardianship"},
    ...
    {name:"Court Petition Initiated- after Court Date Received",description:"Initiate Court Petition after court date is received",is_repeating:false,recurrence_interval:null, max_repeats:null,condition_required:"If emergency and Court Date received",category:"Court",dependency_name:["Court date confirmed"],due_in_days_after_dependency: 1,algorithm:"Guardianship"},
    {name:"Court Petition Filed-after Court Date is Received", description:"File Court Petition after Court Date is Received",is_repeating:false,recurrence_interval:null,max_repeats:null,condition_required:"If emergency and Court Date received",category:"Court",dependency_name:["Court Petition Initiated- after Court Date Received"],due_in_days_after_dependency: 1,algorithm:"Guardianship"},

    {name:"Hospital Representatives to testify identified and notified",description:"Hospital Representatives identified",is_repeating:false,recurrence_interval:null,max_repeats:null,condition_required:"If emergency and Court Date received",category:"Court",dependency_name:["Court Petition Filed-after Court Date is Received"],is_non_blocking:true,algorithm:"Guardianship"},

    {name:"Evaluation and/or supporting documentation completed / available",description:"Evaluating the documents",is_repeating:false,recurrence_interval:null, max_repeats:null,condition_required:null,category:"Documents",dependency_name:["Court Petition Initiated"],is_non_blocking:true,algorithm:"Guardianship"},
    {name:"Responsibility for Court Petition Fees", description:"Find out who is responsible for court petition fees and update the notes",is_repeating:false,recurrence_interval:null,max_repeats:null,condition_required:null,category:"Fees",dependency_name:["Court Petition Initiated"],  is_non_blocking:true,algorithm:"Guardianship"},

    {name:"Guardian ad litem appointed?", description:"Guardian ad litem appointed?",is_repeating:false,recurrence_interval:null, max_repeats:null,condition_required:null,category:"Documents",dependency_name:["Court Petition Filed"],is_non_blocking:true,algorithm:"Guardianship"},
    {name:"Is a fiduciary bond required?", description:"Check if fiduciary bond is required",is_repeating:false,recurrence_interval:null, max_repeats:null,condition_required:null,category:"Documents",dependency_name:["Court Petition Filed"],is_non_blocking:true,algorithm:"Guardianship"},
    ...
    {name:"Submit Application to the State",description:"Submit Application to State",is_repeating:false, recurrence_interval:null,max_repeats:null, condition_required:"If financial LTC and eligibilty determined", category:"Documentation", dependency_name:["Complete Financial Application","Complete the Medical Eligibility Assessment application / required forms and compile supporting medical documentation"],due_in_days_after_dependency:1,algorithm:"LTC"},

    {name:"Follow up with state on application status",description:"Follow up", is_repeating:true, recurrence_interval:5,max_repeats:null,condition_required:"If Medical LTC",category:"State",dependency_name:["Submit Application to the State"],due_in_days_after_dependency:1,algorithm:"LTC"},
    {name:"Begin compiling needed financial/legal information", description:"Start Compiling all the information",is_repeating:false, recurrence_interval:null,max_repeats:null, condition_required:"If financial LTC and eligibilty determined", category:"Documentation", dependency_name:["Submit Application to the State"],due_in_days_after_dependency:1,algorithm:"LTC"},
    ...
    {name:"Confirm date/time of States initial steps including Intake Interview: if not scheduled, follow-up with State",description:"Confirm date/time of States initial steps including Intake Interview: if not scheduled, follow-up with State",is_repeating:true, recurrence_interval:2,max_repeats:null, condition_required:"If submitted documents to state", category:"Court", dependency_name: ["Submit Application to the State"],due_in_days_after_dependency: 1,algorithm:"LTC"},
